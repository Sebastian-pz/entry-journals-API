...
const diariesServices = __importStar(require("../services/diaries"));
...
router.get('/:id', (req, res) => {
    ...
    if (entry) {
        const { comment } = entry, entryWithoutSensitive = __rest(entry, ["comment"]);
...
router.post('/', (req, res) => {
    try {
        const newEntry = (0, utils_1.default)(req.body);
